...
$sql = "SELECT * FROM room where city = 'Chittagong'";
...
$query = "SELECT city as city_name  FROM room where city = 'Chittagong'";
    ...
    <section class="room top" id="room">
        <div class="container">
            <div class="heading_top flex1">
                <div class="heading">
                    <h5>AVAILABLE ROOMS AROUND <?php echo $city_name ?></h5>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p> <span>Single Bed :</span><span><?php echo $row['single_bed'] ?></span> </p>
                                    <p> <span>Double Bed:</span><span><?php echo $row['double_bed'] ?></span> </p>
                                    <p> <span>Air Condition :</span><span><?php echo $row['air_condition'] ?></span>
                                    </p>
